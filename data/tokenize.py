...
#spm.SentencePieceTrainer.train(input='Classical-Modern/classical_raw.txt',model_prefix='classical_tokenizer',vocab_size=10000)

# load trained tokenizer model
sp = spm.SentencePieceProcessor(model_file='classical_tokenizer.model')
with open('Classical-Modern/classical_raw.txt','r',encoding='utf-8') as f:
    data = f.read()
